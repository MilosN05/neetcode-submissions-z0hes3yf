class Solution {
    ...
    // private void dfs_nzero(char[][] board, int i, int j,boolean start) {

    //     if (!start && (i<0 || j<0 || i==board.length || j==board[0].length || observed[i][j]))
    //         return;
    ...
    //                 if (board[s][k]=='O') {
    //                     dfs_nzero(board,s,k, false);
    //                 }
    //             }
    //     else {
    //         dfs_nzero(board,i, j-1, false);
    //         dfs_nzero(board,i, j+1, false);
    //         dfs_nzero(board,i-1, j, false);
    //         dfs_nzero(board,i+1, j, false);
    //     }
